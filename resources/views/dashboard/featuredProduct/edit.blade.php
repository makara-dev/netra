...
<li class="breadcrumb-item" aria-current="page">
    <a href="{{ url('/dashboard') }}" class="breadcrumb-link"></a>
</li>
<li class="breadcrumb-item" aria-current="page">Featured</li>
...
<h3 class="mt-3">Featured Products</h3>
    ...
    <table class="table shadow-lg bg-white mt-3">
        ...
        <tbody>
            ...
            <tr class="table-row" onclick="location.href = '{{url('dashboard/featured/'.$productVariant->product_variant_id.'/update/'.$featuredProduct->featured_product_id)}}'">
                <td>{{$key+1}}</td>
