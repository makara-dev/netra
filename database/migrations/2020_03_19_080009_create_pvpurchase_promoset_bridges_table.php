...
class CreatePvpurchasePromosetBridgesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pvpurchase_promoset_bridges', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pvpurchase_promoset_bridges');
    }
}
